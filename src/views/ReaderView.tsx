...
function ReaderView(): JSX.Element {
  ...
  return (
    <section className="flex flex-1 flex-col gap-8">
      <div className="flex flex-col gap-4 rounded-[28px] border border-white/10 bg-white/[0.04] p-4 shadow-glow sm:flex-row sm:items-center sm:justify-between sm:p-6">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          ...
          {resource.fileUrl != null && (
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2 font-semibold text-slate-200 transition hover:border-primary/60 hover:text-primary"
            >
              ⬇️ Descargar
            </a>
          )}
      ...
      <div className="flex flex-1 flex-col gap-4 rounded-[28px] border border-white/10 bg-white/[0.04] p-4 sm:p-6">
        {hasPages ? (
          ...
          <div className="grid flex-1 place-items-center rounded-2xl border border-white/10 bg-white/[0.03] p-12 text-center text-slate-300">
